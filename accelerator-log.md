...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=AnthonyQi2022&repo=node-express230711",
  "includeTap" : true,
  "projectName" : "node-express230711"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [node-express->node-express230711]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=AnthonyQi2022&repo=node-express230711'
