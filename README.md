...
```
tanzu apps workload create node-express230711 -f config/workload.yaml \
  --local-path . \
  --source-image <REPOSITORY-PREFIX>/node-express230711-source \
  --type web
```
...
```
tanzu apps workload get node-express230711
```
